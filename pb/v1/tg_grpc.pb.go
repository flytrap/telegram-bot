...
func (c *tgBotServiceClient) ImportData(ctx context.Context, opts ...grpc.CallOption) (TgBotService_ImportDataClient, error) {
	stream, err := c.cc.NewStream(ctx, &TgBotService_ServiceDesc.Streams[0], TgBotService_ImportData_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *tgBotServiceClient) UpdateData(ctx context.Context, in *DataItem, opts ...grpc.CallOption) (*RetInfo, error) {
	out := new(RetInfo)
	err := c.cc.Invoke(ctx, TgBotService_UpdateData_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tgBotServiceClient) DeleteData(ctx context.Context, in *DeleteCodes, opts ...grpc.CallOption) (*RetInfo, error) {
	out := new(RetInfo)
	err := c.cc.Invoke(ctx, TgBotService_DeleteData_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TgBotService_UpdateData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TgBotService_UpdateData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TgBotService_DeleteData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TgBotService_DeleteData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	AdService_ListAd_FullMethodName   = "/tg.v1.AdService/ListAd"
	AdService_CreateAd_FullMethodName = "/tg.v1.AdService/CreateAd"
	AdService_UpdateAd_FullMethodName = "/tg.v1.AdService/UpdateAd"
	AdService_DeleteAd_FullMethodName = "/tg.v1.AdService/DeleteAd"
)
...
func (c *adServiceClient) ListAd(ctx context.Context, in *AdFilter, opts ...grpc.CallOption) (*QueryAdResp, error) {
	out := new(QueryAdResp)
	err := c.cc.Invoke(ctx, AdService_ListAd_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdService_ListAd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdService_ListAd_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	CategoryService_ListCategory_FullMethodName   = "/tg.v1.CategoryService/ListCategory"
	CategoryService_CreateCategory_FullMethodName = "/tg.v1.CategoryService/CreateCategory"
	CategoryService_UpdateCategory_FullMethodName = "/tg.v1.CategoryService/UpdateCategory"
	CategoryService_DeleteCategory_FullMethodName = "/tg.v1.CategoryService/DeleteCategory"
)
...
const (
	TagService_ListTag_FullMethodName        = "/tg.v1.TagService/ListTag"
	TagService_GetOrCreateTag_FullMethodName = "/tg.v1.TagService/GetOrCreateTag"
	TagService_UpdateTag_FullMethodName      = "/tg.v1.TagService/UpdateTag"
	TagService_DeleteTag_FullMethodName      = "/tg.v1.TagService/DeleteTag"
)
...
func (c *tagServiceClient) GetOrCreateTag(ctx context.Context, in *Tag, opts ...grpc.CallOption) (*RetInfo, error) {
	out := new(RetInfo)
	err := c.cc.Invoke(ctx, TagService_GetOrCreateTag_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TagService_GetOrCreateTag_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TagService_GetOrCreateTag_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	UserService_ListUser_FullMethodName   = "/tg.v1.UserService/ListUser"
	UserService_CreateUser_FullMethodName = "/tg.v1.UserService/CreateUser"
	UserService_UpdateUser_FullMethodName = "/tg.v1.UserService/UpdateUser"
	UserService_DeleteUser_FullMethodName = "/tg.v1.UserService/DeleteUser"
)
